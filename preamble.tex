...
\usepackage{cancel}                 % needed to cross out stuff in formulas
...
\usepackage{inconsolata}            % consolas font for listings and texttt
...
\renewcommand{\arraystretch}{1}                 % don't stretch table rows
\setlength{\tabcolsep}{1mm}                     % set table column separation to 1mm
