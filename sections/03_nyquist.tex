...
\subsection{Stabilitätsreserven}{130}
...
\begin{minipage}[c]{0.5\columnwidth}
    ...
    $$ \boxed{\Phi_{\rm RES} = \arctan \left( \frac{\Im{G_{0}(\jimg \omega_{D})}}{\Re{G_{0}(\jimg \omega_{D})}} \right) } $$
...
\begin{itemize}
    ...
    \item Nullstellen: $|G(\jimg \omega)|$ \textuparrow\ ; $\angle G(\jimg \omega)$ \textuparrow\ ; \textrightarrow\ Bewegung im Gegenuhrzeigersinn \\
        \textrightarrow\ Bei der Frequenz, bei der die Nullstelle 'zündet', ist $\angle G(\jimg \omega) = \pm 45 \, \degree$
