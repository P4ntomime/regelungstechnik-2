...
\begin{tabular}{c c c c c}
    $K_R = \tilde{K_R} \Big( 1 + \frac{\tilde{T_V}}{\tilde{T_N}} \Big)$ & &
    $T_N = \tilde{T_N + \tilde{T_V}}$ & &
    $T_V = \tilde{T_V} \frac{\tilde{T_N} - \tilde{T_C}}{\tilde{T_N}+ \tilde{T_V}}$ 
\end{tabular}
...
eines PID-Reglers darf im Bodediagramm \textbf{nur Variante 3 gratisch aus den Einzelteilen addiert} werden. 
...
\subsection{Fallstudie: Gleichstromantrieb mit Steuerung}{148-149}


\subsection{Fallstudie: Gleichstromantrieb mit P-Regler}{149-150}
