...
\begin{align*}
    ...
    \frac{Y(s)}{U(s)}                       &= \frac{\text{Zähler}}{\cbl{a_n \cdot s^n + a_{n-1} \cdot s^{n-1} + \ldots + a_2 \cdot s^2  + a_1 \cdot s + a_0 } } \\
    \frac{Y(\jimg \omega)}{U(\jimg \omega)}  &= \frac{\text{Zähler}}{\cbl{a_n \cdot (\jimg \omega)^n + a_{n-1} \cdot (\jimg \omega)^{n-1} + \ldots + a_2 \cdot (\jimg \omega)^2  + a_1 \cdot (\jimg \omega) + a_0 } }
\end{align*}
