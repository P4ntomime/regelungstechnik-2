...
\begin{minipage}[c]{0.42\columnwidth}
    \begin{itemize}
        \item \cgn{Durchtrittsfrequenz $\omega_{D}$}  %\textrightarrow\ Phasenreserve $\Phi_{\rm RES}$
            $$ \Phi_{\rm RES} = 0 \, \deci \bel - K_{\text{@} 180 \degree } $$ 

        \item \cor{Phasenschnittfrequenz $\omega_{\pi}$} % \textrightarrow\ Verstärkungsreserve $\Phi_{\rm RES}$
